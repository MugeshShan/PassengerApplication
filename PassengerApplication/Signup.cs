...
namespace PassengerApplication
{
    public partial class Signup : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var command = String.Format("Insert INTO [Users] ([first_name], [last_name], [email], [mobile], [Address], [username], [password], [role]) VALUES ('{0}', '{1}', '{2}', '{3}', '{4}', '{5}', '{6}', '{7}')", textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text, textBox6.Text, maskedTextBox1.Text, 2);
